...
<div class="wrapper">
    <svg id="Capa_1" data-name="Capa 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 575.41 309.31">
        <defs>
          <style>
            .cls-1 {
              fill: #fff;
    ...
    <video loop class="video1 video1-t" src="/OrbitantInvitado1.mp4" on:mouseenter={handleEnter} on:mouseleave={handleLeave}></video>
    <!-- svelte-ignore a11y-media-has-caption -->
